...
const Services = () => {
  return (
    <section
      id="services"
      className="py-20 bg-gradient-to-r from-gray-50 via-gray-100 to-gray-50 text-center relative overflow-hidden"
    >
      {/* Background Animation */}
      <div className="absolute inset-0 -z-10 pointer-events-none">
        <motion.div
          className="absolute top-[-150px] left-[20%] w-[350px] h-[350px] bg-gradient-to-br from-blue-400 to-purple-400 blur-3xl opacity-25 rounded-full"
          animate={{ x: [0, 30, 0], y: [0, 30, 0] }}
          transition={{ repeat: Infinity, duration: 10, ease: "easeInOut" }}
        />
        <motion.div
          className="absolute bottom-[-150px] right-[25%] w-[400px] h-[400px] bg-gradient-to-br from-purple-400 to-blue-400 blur-3xl opacity-25 rounded-full"
          animate={{ x: [0, -30, 0], y: [0, -30, 0] }}
          transition={{ repeat: Infinity, duration: 10, ease: "easeInOut" }}
        />
      </div>
